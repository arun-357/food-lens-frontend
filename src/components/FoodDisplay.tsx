...
const FoodDisplay: React.FC<FoodDisplayProps> = ({ data }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 w-full max-w-4xl mx-auto items-start">
      {/* Image Box */}
      <div className="relative bg-bento-light dark:bg-bento-dark rounded-2xl shadow-xl overflow-hidden md:transform md:hover:scale-105 transition-transform duration-300 border-2 border-green-200 dark:border-green-800">
        <img
          src={imgSrc}
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex items-center justify-center opacity-0 md:hover:opacity-100 transition-opacity duration-500 pointer-events-none">
      ...
      <div className="bg-bento-light dark:bg-bento-dark p-4 sm:p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
        <div className="markdown-content text-gray-600 dark:text-gray-300 space-y-4 text-left break-words">
          <ReactMarkdown
            components={{
              h2: ({ children }) => (
